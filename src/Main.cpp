...
int main()
{
    ...
    Shader colShader = Shader("./header/Ball/col.vs", "./header/Ball/col.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        for (int i = 0; i < numBalls; i++) {
            balls[i].draw(ballShader,colShader, deltaTime, box.sizeX, box.sizeY,box.sizeZ, balls, i, projection, view, ballProp);
